...
namespace vmime
{
	...
	*/
    ...
    typedef void (*tTraceCallback)(const char* s8_Trace);
    static tTraceCallback traceCallback = 0;
    void SetTraceCallback(tTraceCallback f_Callback, int s32_GnuTlsLevel=3);
