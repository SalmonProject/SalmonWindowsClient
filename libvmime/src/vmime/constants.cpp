...
namespace mediaTypes
{
	...
	// FIX by Elmue: Added
	const string::value_type* const TEXT_CALENDAR = "calendar";
...
namespace charsets
{
	...
	const string::value_type* const UTF_16 = "utf-16"; // depends on BOM if Little endian or Big endian
	const string::value_type* const UTF_32 = "utf-32"; // depends on BOM if Little endian or Big endian
	...
	// FIX by Elmue: Added
	const string::value_type* const WSTRING = "utf-16le";  // character encoding in std::wstring
}
