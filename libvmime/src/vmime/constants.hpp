...
namespace vmime
{
	...
	namespace mediaTypes
	{
		...
		// FIX by Elmue: Added
		extern VMIME_EXPORT const string::value_type* const TEXT_CALENDAR;
	...
	namespace charsets
	{
		...
		// FIX by Elmue: Added
		extern VMIME_EXPORT const string::value_type* const WSTRING;  // character encoding in std::wstring
	}
