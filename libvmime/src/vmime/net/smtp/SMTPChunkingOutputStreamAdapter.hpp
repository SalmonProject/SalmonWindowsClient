...
public:
	...
	// FIX by Elmue: Added ProgressListener
	SMTPChunkingOutputStreamAdapter(ref <SMTPConnection> conn, utility::progressListener* progress, utility::stream::size_type size);
...
private:
	...
	utility::stream::size_type m_totSize;
	utility::stream::size_type m_sentBytes;
