...
public:
    ...
    // FIX by Elmue: Added these important functions
    static path path::fromString(const char c_Separator, const string s_Path);
    string toString(const char c_Separator);
