...
public:
    ...
    */
    static string  WstringToUtf8(const wstring& inUnicode);
    static wstring Utf8ToWstring(const  string& inUtf8);
    static wstring CpToWstring  (const  string& in, const vmime::charset& charsetIn);
